...
*/
const XPTN = 'BOT ASWIN V2'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/aswin_id'; // Nama Instagramlu cok
...
const youtube = ''; // OFFICIAL GRUP LU 2
//
...
if (text.includes('.cuaca')){
  ...
  var teks = text.replace(/.cuaca /, '')

    axios.get(`https://mhankbarbar.herokuapp.com/api/cuaca?q=${teks}&apiKey=N2Ws9kp3KTDYtry5Jjyz`).then((res) => {
